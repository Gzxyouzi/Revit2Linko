...
{
    class upload_all_project : IExternalEventHandler
    {
        ...
        public void Execute(UIApplication app)
        {
            ...
            foreach (var revitColumn in columnElements)
            {
                ...
                var level = doc.GetElement(revitColumn_Instance.LevelId) as Autodesk.Revit.DB.Level;
            ...
            {                        
                ...
                var level = doc.GetElement(floorInstance.LevelId) as Autodesk.Revit.DB.Level;
                string level_name = level.Name;
